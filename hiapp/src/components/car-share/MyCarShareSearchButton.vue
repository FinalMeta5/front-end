<template>
    <div>
        <button @click="goToCarRegi" class="car-regi-btn">내 차량 공유 서비스 조회</button>
...
export default {
    ...
    setup() {
        ...
        return { goToCarRegi, showLoginModal, showErrorModal, errorMessage, handleLoginSuccess, redirectPath };
    },
};
</script>
