...
const routes = [
  ...
  {
    path: "/car-share/service/registration/first",
    component: CarShareServiceRegiFirstView,
  },
  {
    path: "/car-share/service/registration/second",
    component: CarShareServiceRegiSecondView,
  },
  { path: "/no-car-info", component: NoCarInfoView },
  ...
  {
    path: "/taxi-share/regist-complete",
    component: TaxiShareRegistCompleteView,
  },
